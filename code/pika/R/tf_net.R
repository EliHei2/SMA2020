...
#' \describe{
#' \item{spec}{A character string indicating the organism. possible values = `c('cattle', 'chicken','chimpanzee', 'dog_domestic', 'frog_western clawed', 'human', 'mouse_laboratory','rat', 'zebrafish')`.}
#' \item{tf_subset}{A vector of character strings indicating the transcription factors to be selected.}
