...
# wflow_build(files='analysis/sma03_scPotter_out_embryo1.Rmd', view=F, verbose=T, delete_cache=T)
```
...
data_dir        = 'data/sma03_scPotter/pred/embryo1_5'
out_dir         = 'output/sma03_scPotter/embryo1_5'
